...
function draw() {
  ...
  let collisionBox = get(midW - player.collision.mw, midH - player.collision.mh, player.collision.w, player.collision.h)
...
function debugCode(){
  ...
  fill('red')
  rect(midW - player.collision.mw, midH - player.collision.mh, player.collision.w, player.collision.h)
}
